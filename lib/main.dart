...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(_app, title: 'Tic Tac Toe Game'),
    );
  }
}

class MyHomePage extends StatefulWidget {
  MyHomePage(this.app, {Key key, this.title}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            MaterialButton(
              ...
              child: new Text('Play multiplayer',
            ...
            MaterialButton(
              ...
              height: 35,
              color: Color(0xFF801E48),
              child: new Text('Join existing game',
                  style: new TextStyle(fontSize: 16.0, color: Colors.white)),
              onPressed: () {
                Navigator.push(
                  context,
